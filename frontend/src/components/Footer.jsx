  ...
  return (
    <footer className="relative px-[100px] w-full bg-[url(https://tonyreinke.com/wp-content/uploads/2020/01/771cbf11649b35319a9117055f05501b-cinema_zed-stuk.jpg)] bg-cover">
      ...
      <div className=" relative w-full p-8 px-20 z-10 text-white">
        ...
        <div className="flex flex-col items-center justify-center w-full pt-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
          <p className="block mb-4 text-sm text-center text-slate-400 md:mb-0"></p>
          <div className="flex gap-4 text-slate-300 sm:justify-center">
            <a
              href="#"
